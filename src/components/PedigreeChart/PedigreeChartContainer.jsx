...
export default function PigeonPedigreeChart() {
    const {data,isLoading}=useGetPigeonPedigreeChartDataQuery()
    console.log(data)
  // Correct pedigree structure: Each pigeon has exactly 1 father and 1 mother
  const initialNodes = [
    // Generation 0 - Subject (1 pigeon)
    {
      id: 'subject',
      type: 'pigeonNode',
      position: { x: 50, y: 400 },
    ...
    // Generation 1 - Parents (2 pigeons: 1 father + 1 mother)
    {
      id: 'father_1',
      type: 'pigeonNode',
      position: { x: 350, y: 50 },
    ...
    // Generation 2 - Grandparents (4 pigeons: 2 fathers + 2 mothers)
    {
    ...
    // Generation 3 - Great-grandparents (8 pigeons: 4 fathers + 4 mothers)
     {
    ...
    // Generation 4 - Great-great-grandparents (16 pigeons: 8 fathers + 8 mothers)
  ...
  // Correct edge connections - each pigeon connects to exactly 1 father and 1 mother
  const initialEdges = [
    // Subject to Parents
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 mt-6">
